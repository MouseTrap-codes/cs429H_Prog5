...
void populateInstMap() {
    ...
    // "priv" will be used for halt expansion.
...
// If mnemonic is "mov" or "brr", use our custom routines; otherwise, standard.
...
// ---------------- Final Assembly Pass ----------------
// This function reads the original assembly file, performs macro expansion,
// label substitution, and writes the final binary output directly.
